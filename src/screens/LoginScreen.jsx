    ...
    <View className="flex-1 bg-[#010919] py-4">
      ...
      <View className="flex-1 bg-gray-900 px-8 pt-8" style={{borderTopLeftRadius: 50, borderTopRightRadius: 50}} >
        ...
        <View className="w-full mt-1">
          <Text className="text-white text-lg text-center">Not a member? <Text onPress={() => navigation.navigate('Register')} className="text-green-500 font-extrabold">Register</Text></Text>
        </View>
      </View>
    </View>
  );
